  ...
  return (
    <section
     className='grid grid-cols-1 md:grid-cols-2 gap-2 w-full ' id="home" >
      <div className='py-2 md:-mt-48 flex-1 flex flex-col items-start  justify-center gap-6'>
      ...
      <img src={HeroBg} className='ml-auto w-full h-auto  lg:w-460 lg:h-auto top-40' alt="hero-bg"  />
        ...
        <div className='w-full h-full absolute top-0 left-10 flex items-center justify-center px-48 py-4 gap-4 flex-wrap drop-shadow-lg '>
           {heroData && heroData.map(n=>(
             <div key={n.id} className='lg:w-190  p-3  bg-cardOverlay backdrop-blur-l rounded-3xl flex flex-col items-center justify-center drop-shadow-lg ' >
             ...
             <p className='text-[12px] lg:text-md text-lighttextGray font-semibold my-1 lg:my-4'>{n.decp} </p>
