    ...
    <header className="fixed z-50 w-screen p-3 px-5 md:p-6 md:px-16 bg-primary">
      ...
      <div className="hidden md:flex w-full h-full items-center justify-between ">
        <Link to={"/"} className="flex items-center gap-2">
          ...
          <p className="text-headingColor text-xl font-bold">Food 4 U</p>
        </Link>
        ...
        <div className="flex items-center gap-8">
          ...
          >
            <li className="text-base text-textColor hover:text-headingColor duration-100 transition-all ease-in-out cursor-pointer font-bold">
              Home
            </li>
            <li className="text-base text-textColor hover:text-headingColor duration-100 transition-all ease-in-out cursor-pointer font-bold">
              Menu
          ...
          {isMenu && (
            ...
            >
              {user && user.email === "souravmisra4125@gmail.com" && (
                <Link to={"/createItem"}>
                  <p
                    className="flex items-center gap-3 cursor-pointer hover:bg-slate-200 transition-all duration-100 ease-in-out text-textColor text-base px-4 py-2"
                    onClick={() => setisMenu(false)}
                  >
                    New Item <MdAdd />
                  </p>
              ...
              <p
                className="m-2 p-2 rounded-md shadow-md flex items-center justify-center bg-gray-200 gap-3 cursor-pointer hover:bg-slate-400 transition-all duration-100 ease-in-out text-textColor text-base "
                onClick={logout}
              >
                LogOut <MdLogout />{" "}
              </p>
